...
phyla_richness_versus_trees_plot <- draw_linear_regression(
  ...
  title = "phyla richness vs tree richness 2022",
  xlab = "Tree Richness",
  ylab = "Richness (log)"
)
family_richnees_versus_trees_plot <- draw_linear_regression(
  ...
  response = "richness",
  predictor = "tree_richness",
  title = "family richness vs tree richness 2022",
  xlab = "Tree Richness",
  ylab = "Richness (log)"
)
genus_richness_versus_trees_plot <- draw_linear_regression(
  ...
  response = "richness",
  predictor = "tree_richness",
  title = "genus richness vs tree richness 2022",
  xlab = "Tree Richness",
  ylab = "Richness (log)"
)
panel_richness_versus_trees_2022 <- plot_grid(
...
ggsave(
    filename = paste0(
      ...
      "panel_richness_versus_trees_2022.png"
    ),
    plot = panel_richness_versus_trees_2022,
  width = unit(21, "cm"),
  height = unit(7, "cm")
)
# svg
ggsave(
    filename = paste0(
      exploratory_figures_dir, 
      "panel_richness_versus_trees_2022.svg"
    ),
    plot = panel_richness_versus_trees_2022,
  width = unit(21, "cm"),
  height = unit(7, "cm")
...
co2_versus_richness_phyla_plot <- draw_linear_regression(
  ...
  response = "co2",
  predictor = "richness",
  title = "co2 vs microbial richness 2022",
...
panel_co2_versus_richness_2022 <- plot_grid(
...
ggsave(
    filename = paste0(
      exploratory_figures_dir, 
      "panel_co2_versus_richness_2022.png"
    ),
    plot = panel_co2_versus_richness_2022,
  width = unit(21, "cm"),
  height = unit(7, "cm")
)
...
ggsave(
    filename = paste0(
      exploratory_figures_dir, 
      "panel_co2_versus_richness_2022.svg"
    ),
    plot = panel_co2_versus_richness_2022,
  width = unit(21, "cm"),
  height = unit(7, "cm")
...
ch4_versus_richness_phyla_plot <- draw_linear_regression(
  ...
  response = "ch4",
  predictor = "richness",
  title = "ch4 vs microbial richness 2022",
  xlab = "Microbial Richness",
  ylab = "Ch4 (mg/m²/day)"
)
...
panel_ch4_versus_richness_2022 <- plot_grid(
...
ggsave(
    filename = paste0(
      exploratory_figures_dir, 
      "panel_ch4_versus_richness_2022.png"
    ),
    plot = panel_ch4_versus_richness_2022,
  width = unit(21, "cm"),
  height = unit(7, "cm")
)
...
ggsave(
    filename = paste0(
      exploratory_figures_dir, 
      "panel_ch4_versus_richness_2022.svg"
    ),
    plot = panel_ch4_versus_richness_2022,
  width = unit(21, "cm"),
  height = unit(7, "cm")
...
phyla_richness_versus_trees_plot2 <- draw_linear_regression(
  ...
  y_breaks = c(2.6, 2.93, 3.26),
  y_breaks_labels = c("2.6", "2.93", "3.26")
)
genus_richness_versus_trees_plot <- draw_linear_regression(
  df = genus_df,
  response = "richness",
  ...
  x_breaks = c(0, 1, 3, 6, 12, 24),
  x_breaks_labels = c("0", "1", "3", "6", "12", "24"),
  y_breaks = c(4.2, 4.85, 5.55),
  y_breaks_labels = c("4.2", "4.85", "5.55")
)
panel1 <- plot_grid(
...
ggsave2(
    filename = paste0(
      main_figures_dir, 
      "panel_richness_versus_trees_2022"
    ),
    plot = panel1,
  width = unit(21, "cm"),
  height = unit(7, "cm")
...
diversity_phyla_versus_trees_plot <- draw_linear_regression(
  ...
  x_breaks = c(0, 1, 3, 6, 12, 24),
  x_breaks_labels = c("0", "1", "3", "6", "12", "24"),
  y_breaks = c(5.15, 5.9, 6.78),
  y_breaks_labels = c("5.15", "5.9", "6.78")
)
diversity_genus_versus_trees_plot <- draw_linear_regression(
  ...
  x_breaks = c(0, 1, 3, 6, 12, 24),
  x_breaks_labels = c("0", "1", "3", "6", "12", "24"),
  y_breaks = c(30.6, 43, 56),
  y_breaks_labels = c("30.6", "43", "56")
)
panel2 <- plot_grid(
...
ggsave2(
    filename = paste0(
      main_figures_dir, 
      "panel_diversity_versus_trees_2022"
    ),
    plot = panel2,
  width = unit(21, "cm"),
  height = unit(7, "cm")
...
co2_versus_trees_plot <- draw_linear_regression(
  ...
  x_breaks = c(0, 1, 3, 6, 12, 24),
  x_breaks_labels = c("0", "1", "3", "6", "12", "24"),
  y_breaks = c(1000, 13000, 23600),
  y_breaks_labels = c("1000", "13000", "23600")
)
...
ch4_versus_trees_plot <- draw_linear_regression(
  ...
  x_breaks = c(0, 1, 3, 6, 12, 24),
  x_breaks_labels = c("0", "1", "3", "6", "12", "24"),
  y_breaks = c(-2.4, 3.1, 8),
  y_breaks_labels = c("-2.4", "3.1", "8")
)
